...
import { ArrowRightCircle, Check, ChevronsUpDown } from "lucide-react";
...
export const DesignConfigurator = ({ configId, imageDimensions, imageUrl }: Props) => {
        ...
        <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
            <div ref={containerRef} className="relative h-[37.5rem] overflow-hidden col-span-2 w-full max-w-4xl flex items-center justify-center rounded-lg border-2 border-dashed border-gray-300 p-12 text-center focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
                <div className="relative w-60 bg-opacity-50 pointer-events-none aspect-[896/1831]">
                    <AspectRatio ref={phoneCaseRef} ratio={896 / 1831} className="relative pointer-events-none z-50 aspect-[896/1831] w-full">
                        <NextImage src="/phone-template.png" alt="phoneimg" className="pointer-events-none z-50 select-none" fill />
                    </AspectRatio>
                ...
                >
                    <div className="relative w-full h-full">
                        <NextImage src={imageUrl} alt="phonecover" fill className="pointer-events-none" />
                    </div>
                </Rnd>
            </div>
                                    ...
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent>
                                            {MODELS.options.map((model) => (
                                                <DropdownMenuItem
                                                    key={model.label}
                                                    className={cn("flex text-sm gap-1 items-center p-1.5 cursor-pointer hover:bg-zinc-100", {
                                                ...
                                                >
                                                    <span className="flex items-center">
                                                        <span className="flex flex-col text-sm">
                                                            ...
                                                            {option.description ? (
                                                                <RadioGroup.Description as="span" className="text-gray-500 text-[13px]">
                ...
                <div className="w-full px-8 h-16 bg-white">
                    ...
                    <div className="w-full h-full flex justify-end items-center">
                        <div className="w-full flex gap-6 items-center">
                            ...
                            >
                                Continue
                                <ArrowRightCircle className="h-3.5 w-3.5 ml-1.5 inline" />
                            </Button>
                        </div>
                    </div>
                </div>
