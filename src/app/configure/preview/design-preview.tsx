        ...
        <>
            ...
            <div className="mt-20 flex flex-col items-center md:grid text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12">
                ...
                <div className="mt-6 sm:col-span-9 sm:mt-0 md:row-end-1">
                    ...
                    <div className="mt-3 flex items-center gap-1.5 text-[14.5px]">
                        <CheckCircle2 className="h-4 w-4 text-green-500" />
                        In stock and ready to ship
                    </div>
                </div>

                <div className="sm:col-span-12 md:col-span-9 text-[14.5px]">
                    <div className="grid grid-cols-1 gap-y-8 border-b border-gray-200 py-8 sm:grid-cols-2 sm:gap-x-6 sm:py-6 md:py-10">
                        <div>
                            ...
                            <ol className="mt-3 text-zinc-700 list-disc list-inside text-[13px]">
                    ...
                    <div className="mt-8">
                        <div className="bg-gray-100/80 p-6 sm:rounded-lg sm:p-8">
                        ...
                        <div className="mt-8 flex justify-end pb-12">
                            <Button className="px-4 sm:px-6 lg:px-8" onClick={() => handleCheckout()}>
                                Check out
                                <ArrowRightCircle className='h-3.w-3.5 w-3.5 ml-1.5 inline' />
                            </Button>
                        </div>
                    </div>
                </div>
