...
export const OrderReceivedEmail = ({ orderDate, orderId, shippingAddress }: Props) => {

    const baseUrl = process.env.NODE_ENV === 'development' ? 'http://localhost:3000' : 'https://phonecase-site.vercel.app';
